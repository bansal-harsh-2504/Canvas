      ...
      <section className="text-black">
        <div className="container mx-auto px-4 py-10">
          <div className="max-w-3xl">
            ...
            <Link href="/login">
              <button className="px-8 py-4 cursor-pointer outline-1 hover:bg-indigo-600 hover:text-white transition ease-out text-indigo-600 rounded-lg font-medium text-lg hover:bg-opacity-90">
                Start Drawing →
              </button>
            </Link>
          </div>
